...
export default class BoundingBox {
  ...
  setPosition(percentageOffsetX, percentageOffsetY, triggerRect) {
    ...
    console.log("triggerRect.left:", triggerRect.left)
    console.log("percentageOffsetX:", percentageOffsetX)
    console.log("triggerRect.width:", triggerRect.width)
    console.log("this.el.clientWidth:", this.el.clientWidth)
    console.log("pageXOffse:", pageXOffse)
